...
<script>
  ...
  $.simpleWeather({
    ...
    success: function(weather) {
	  ...
	  html += '<br/>';
	  html += '<h4 style="float:right"><BR/>Last Updated:'+d.getHours()+':'+d.getMinutes()+'</h4>';
								...
								<div id="content" class="8u skel-cell-mainContent">
									...
									<!-- Post -->
										<article class="is-post">
											...
											<script type="text/javascript" src="http://ajax.googleapis.com/ajax/static/modules/gviz/1.0/chart.js"> {"dataSourceUrl":"http://docs.google.com/spreadsheet/tq?key=0AhuR1ISrt5B1dGd2cDlZRy12X1JvY0dOOUNlZUUwMEE&transpose=0&headers=1&gid=0&pub=1","options":{"scaleColumns": 2,"displayAnnotations":true,"titleTextStyle":{"fontSize":16},"animation":{"duration":500},"allValuesSuffix":"F","width":640,"fill":1,"hAxis":{"useFormatFromData":true,"minValue":null,"viewWindow":{"min":null,"max":null},"maxValue":null},"wmode":"opaque","vAxes":[{"useFormatFromData":true,"minValue":null,"viewWindow":{"min":null,"max":null},"maxValue":null},{"useFormatFromData":true,"minValue":null,"viewWindow":{"min":null,"max":null},"maxValue":null}],"booleanRole":"certainty","title":"UMKC TEMPERATURE GRAPH","height":302,"legend":"right"},"state":{},"view":{},"isDefaultVisualization":true,"chartType":"AnnotatedTimeLine","chartName":"Chart 1"} </script>
