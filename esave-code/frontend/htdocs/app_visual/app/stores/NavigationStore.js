(function(){
var StateItems = [
    {key: 'ALL', label: 'All DEVICES', leaf: true},
   // {key: 'AL', label: 'Alabama', leaf: true},
    {key: 'AL', label: 'Refrigerator', leaf: true},
    {key: 'AK', label: 'Water Heater', leaf: true},
    {key: 'AZ', label: 'Gas in Cooking', leaf: true},
    {key: 'AR', label: 'Air Conditioner', leaf: true},
    {key: 'CA', label: 'Air Heater', leaf: true},
...
//Ext.Msg.alert(' Your Navigation Store is loaded Successfully !!!');
})();